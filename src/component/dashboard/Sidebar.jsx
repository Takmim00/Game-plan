...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  return (
    ...
    >
      ...
      <button className="bg-gradient-to-r from-purple-700 to-purple-500 text-white rounded-md py-2 px-4 font-medium hover:opacity-90 transition">
        + New Plan
      </button>
      ...
      <div className="mt-8">
        <h2 className="text-sm font-semibold text-gray-500">Recent Plans</h2>
        <select className="mt-2 w-full border rounded-md text-gray-700 p-2 focus:outline-none">
          <option>All Plans</option>
          <option>Work</option>
          <option>Personal</option>
        </select>
        <p className="mt-4 text-gray-600 text-sm">2025-07-29</p>
      </div>

      <div className="mt-6">
        <h2 className="text-sm font-semibold text-gray-500">Edited Plans</h2>
        <p className="text-gray-400 text-sm">No edited chats found.</p>
      </div>

      <button className="mt-auto bg-gradient-to-r from-purple-700 to-purple-500 text-white rounded-md py-2 px-4 font-medium hover:opacity-90 transition">
        Upgrade To Pro
      </button>
    </div>
  );
