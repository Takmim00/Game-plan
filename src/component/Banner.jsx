...
const Banner = () => {
  return (
    <div className="relative  bg-gradient-to-r from-purple-700 to-purple-500 text-white overflow-hidden">
      <div className="absolute w-64 h-64 md:w-96 md:h-96 bg-pink-500 opacity-20 rounded-full blur-3xl bottom-40 right-[200px] lg:right-[650px] animate-float-slow z-0"></div>
      <div className="absolute w-64 h-64 md:w-96 md:h-96 bg-pink-500 opacity-20 rounded-full blur-3xl -top-16 -right-0 animate-float z-0"></div>
      <div className="absolute w-64 h-64 md:w-96 md:h-96 bg-pink-500 opacity-20 rounded-full blur-3xl -top-[150px] -left-[150px] animate-float-reverse z-0"></div>

      <nav className="relative z-10 flex justify-between items-center w-11/12 mx-auto py-4 ">
        ...
        <button className="hidden md:block text-lg font-bold z-50 bg-purple-600 hover:bg-purple-500 text-white px-6 py-2 rounded-full">
          Login / Sign Up
        </button>
      </nav>

      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-11/12 mx-auto h-[calc(90vh-80px)]">
        <div className="max-w-xl space-y-6">
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
            Plan Your <br /> Coaching Sessions In <br /> Seconds
          </h1>
          ...
          <div>
            <div class="flex flex-col md:flex-row lg:items-center space-y-4 md:space-y-0 md:space-x-4">
              <button class="bg-[#CC7FFF] text-white px-16 py-4 rounded-full font-semibold">
                Start for Free
              </button>
            </div>
        ...
        {/* Right Image */}
        <div className="mt-10 md:mt-0 flex items-end h-full">
          <img
            src={banner}
            alt="Coach with kids"
