...
const Maximize = () => {
  return (
    <div class="relative py-10 md:py-16 w-11/12 mx-auto">
      <div class="relative flex flex-col lg:flex-row items-center justify-between">
        ...
        <div class="relative flex items-center justify-center">
          <div class="absolute -top-16 lg:-top-6 right-24 w-56  hidden lg:block  h-56 lg:w-96 lg:h-96 rounded-full "></div>
          <div class="relative z-20">
            <div class=" overflow-hidden ">
              <img
                src={img}
                alt="Dashboard"
                class="w-[300px] md:w-[450px] lg:w-[550px] h-auto object-cover z-20"
              />
            </div>
          </div>
        </div>
